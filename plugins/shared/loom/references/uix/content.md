...
```text
MCP, Loom, requestRef, phase, delivery, task result, verification command,
localhost, Docker, Gradle, npm, Prisma, Spring Boot, SQLite,
schema, enum, artifact, generated by agent, build passed
```
...
In `frontendQualitySelfCheck`, cite changed files or screens that prove:
