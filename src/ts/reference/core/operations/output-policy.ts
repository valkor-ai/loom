...
export function refFirstRequestReadProtocol(): Record<string, unknown> {
  return {
    ...
    readRule: "After opening requestRef, use requestReadPlan.groups[].readCommand.",
