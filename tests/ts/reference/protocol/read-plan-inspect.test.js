...
const { agentActionContract, brainstormSessionAgentActionContract, normalizeAgentActionForFieldGroups } = require("../../../../src/ts/reference/dist/core/operations/agent-action");
...
assertNotIncludes("core/operations/output-policy.ts", "agentAction.read", "output policy must not expose legacy read compatibility to agents.");
assertIncludes("core/operations/output-policy.ts", "inspect readCommand", "output policy must mention inspect readCommand.");
assertNotIncludes("core/operations/output-policy.ts", "--limit", "request read protocol must not use content limits.");
assertIncludes("core/operations/tasks.ts", "frontendImplementationOrganizationRules", "TaskPlan/TaskExecution must expose frontend responsibility-boundary rules.");
assertIncludes("core/operations/tasks.ts", "UI/view", "frontend organization rules must name UI/view responsibility.");
assertIncludes("core/operations/tasks.ts", "API/service interaction", "frontend organization rules must name API/service responsibility.");
assertIncludes("core/operations/tasks.ts", "state/feedback handling", "frontend organization rules must name state/feedback responsibility.");
assertIncludes("core/operations/tasks.ts", "verification/test evidence", "frontend organization rules must name verification/test responsibility.");
