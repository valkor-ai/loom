...
async function main() {
  const { initProject } = require("../../../../src/ts/reference/dist/core/operations/init-project");
  const { writeRequestManifestAtomic } = require("../../../../src/ts/reference/dist/core/operations/request-manifest");
  const { readTokenSavingSummary } = require("../../../../src/ts/reference/dist/core/operations/token-saving-telemetry");
  const { printEnvelope } = require("../../../../src/ts/reference/dist/commands/output");
